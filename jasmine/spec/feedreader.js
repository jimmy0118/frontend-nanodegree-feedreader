...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('All feeds have a URL defined and it is not empty', function() {
    ...
    describe('The menu', function() {
         ...
         */
        let defaultMenu = document.querySelector('body');
        let menuIcon = document.querySelector('.menu-icon-link');

        it('Default menu is hidden.', function() {
            expect(defaultMenu.classList.contains('menu-hidden')).toBe(true);
        });
        ...
        it('Menu changes visibility when menu icon is clicked.', function() {
            menuIcon.click();
            expect(defaultMenu.classList.contains('menu-hidden')).toBe(false);
